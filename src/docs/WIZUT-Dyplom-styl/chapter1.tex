...
Do wyuczenia klasyfikatora i wybrania zbioru cech użyto algorytmu AdaBoost.
...
Badane okno w pierwszej kolejności badane są przez słabsze klasyfikatory, które bazują na mniejszej liczbie cech.
...
Do osiągnięcia pozytywnego wyniku, wymagane jest zwrócenie przez wszystkie klasyfikatory pozytywnej odpowiedzi.
...
Każdy etap kaskady jest uczony w ramach boostingu (np. poprzez AdaBoost lub
RealBoost).
...
Po raz pierwszy została ona przedstawiona w \cite{Freund1996ExperimentsWA}.
