...
%----------------------------------------------------------------------------------------
  ...
  \include{chapter3} % chapter2.tex zawiera treść rozdziału 2
  \include{chapter4} % chapter2.tex zawiera treść rozdziału 2
%\include{chapter5} % chapter2.tex zawiera treść rozdziału 2
%\include{chapter6} % chapter2.tex zawiera treść rozdziału 2
